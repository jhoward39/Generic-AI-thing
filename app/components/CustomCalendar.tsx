...
export default function CustomCalendar({ value, onChange, placeholder = "mm/dd/yyyy", className = "", openDirection = 'down' }: CustomCalendarProps) {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {/* Calendar Dropdown */}
      {isOpen && (
        <div className={`absolute ${openDirection === 'up' ? 'bottom-full mb-1' : 'top-full mt-1'} left-0 z-20 bg-[#FFFFF8] dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg p-4 transition-colors duration-200`}>
            <style jsx global>{`
              .react-calendar {
