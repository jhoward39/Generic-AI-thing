    ...
    <div className="min-h-screen bg-[#FFFFF8]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center my-8">
          <h1 className="text-4xl text-gray-900">Task List</h1>
        </div>
          ...
          <div className="bg-transparent rounded-lg p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-purple-50 p-4 rounded-lg">
                <h3 className="font-medium text-purple-800">Critical Path Tasks</h3>
                <p className="text-2xl text-purple-600">
                  {dependencyInfo.criticalPath.criticalPath.length}
                </p>
              </div>
              <div className="bg-pink-50 p-4 rounded-lg">
                <h3 className="font-medium text-pink-800">Project Duration</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="btn-primary w-full px-4 py-3 disabled:cursor-not-allowed"
                >
                  Add Dependency
                </button>
              </div>
