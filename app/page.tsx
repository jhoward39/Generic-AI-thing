        ...
        <div className="min-h-screen bg-[#FFFFF8]">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <p className="text-black text-lg">Task Management with Dependencies & Critical Path Analysis</p>
                </div>
                    ...
                    <div className="bg-transparent rounded-lg shadow-xl p-6 mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="bg-purple-50 p-4 rounded-lg">
                                ...
                                <p className="text-2xl  text-purple-600">{dependencyInfo.criticalPath.criticalPath.length}</p>
                            </div>
                            <div className="bg-pink-50 p-4 rounded-lg">
                                <h3 className="font-semibold text-pink-800">Project Duration</h3>
                                <p className="text-2xl  text-pink-600">{dependencyInfo.criticalPath.totalDuration} days</p>
                            </div>
                        </div>
                    </div>
                )}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="flex items-end">
                                <button
                                    ...
                                    className="w-full bg-green-600 text-black px-4 py-3 rounded-lg hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition duration-300"
                                >
                                    Add Dependency
                                </button>
                            </div>
                ...
                <div className="bg-transparent rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                        {todos.map((todo) => (
                            <div
                                key={todo.id}
                                className={`p-6 rounded-lg border-2 ${todo.isOnCriticalPath
                                ...
                                <div className="flex justify-between items-start">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-2">
                                            <h3 className={`text-xl font-semibold ${isOverdue(todo.dueDate) ? 'text-red-600' : 'text-gray-800'
                                                }`}>
                                                {todo.title}
                                            </h3>
